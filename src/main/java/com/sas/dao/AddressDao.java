...
@Slf4j
@Repository
public class AddressDao implements Constant {
    ...
    public List<Address> getAddressDetails(EmployeeRequest filterRequest) {
    ...
    private List<Predicate> getPredicates(EmployeeRequest request, CriteriaBuilder cb, Root<Address> root) {
